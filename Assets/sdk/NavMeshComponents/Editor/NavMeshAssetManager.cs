...
namespace UnityEditor.AI
{
    public class NavMeshAssetManager : ScriptableSingleton<NavMeshAssetManager>
    {
        ...
        static void CreateNavMeshAsset(NavMeshSurface surface)
        {
            ...
            if(AssetDatabase.IsMainAsset(surface.navMeshData))
                surface.navMeshData = Instantiate(surface.navMeshData);
//            combinedAssetPath = AssetDatabase.GenerateUniqueAssetPath(combinedAssetPath);
        ...
        public void StartBakingSurfaces(UnityEngine.Object[] surfaces)
        {
            ...
            foreach (NavMeshSurface surf in surfaces)
            {
                ...
                oper.bakeData = surf.navMeshData? surf.navMeshData:InitializeBakeData(surf);
...
//                    surface.RemoveData();
        ...
        public static void SetNavMeshData(NavMeshSurface navSurface, NavMeshData navMeshData)
        {
